...
function VerticalNavbarBusiness() {
  ...
  return (
    <div className=" bg-blue-500 h-screen w-72 flex flex-col px-5 pt-5 ">
      ...
      <Link href="/BusinessPage/OrdersViewPage">
      ...
      <Link href="/BusinessPage/CRUDProductBusiness">
        <div className="flex flex-row mt-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <Link href="/">
        <div className="flex flex-row mt-2">
          ...
          <h3 className="pl-3">Empresa</h3>
        </div>
      </Link>
      <Link href="/">
        <div className="flex flex-row mt-2 fixed bottom-0 mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
...
export default VerticalNavbarBusiness;
